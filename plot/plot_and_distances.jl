...
function myplot(measure, legendplace, yaxisscale, xaxisscale, variable, variableRT, variableRE, variableEU, variableEUB, variableHY, variableHYSB, av, avRT, avRE, avEU, avEUB, avHY, avHYSB)
    ...
    p = plot(av, variable[1, :], fillrange=variable[3, :], fillalpha=fillalpha, c=blue, label="", lw=0, palette=:Set1_9, legend=legendplace, legendfontsize=12, xlims=(0, 170), grid=false, dpi=1200, yaxis=yaxisscale, xaxis=xaxisscale, xticks = ([0, 50, 100, 150, 200], [L"0", L"50", L"100", L"150", L"200"]), yticks = yticks, xguidefontsize=12,yguidefontsize=12 ,xtickfontsize=12,ytickfontsize=12)
    ...
    plot!(avEU, variableEU[2, :], label=L"\mathrm{Random \,\, torus\,\, }v=0.1", lw=line_lw, c=orange)
    ...
    plot!(avHY, variableHY[2, :], label=L"\mathrm{Random\,\, hyperbolic \,\, }α=0.5, v=0.1, ζ=1", c=violet, lw=line_lw)
    plot!(avHYSB, variableHYSB[1, :], fillrange=variableHYSB[3, :], fillalpha=fillalpha, c=red, label="", lw=0)
    plot!(avHYSB, variableHYSB[2, :], label=L"\mathrm{Random \,\, hyperbolic \,\, }α=1.05, v=0.8, ζ=1 ", c=red, lw=line_lw)
