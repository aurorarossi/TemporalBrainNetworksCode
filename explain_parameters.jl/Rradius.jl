...
p=plot(Rrange,avHY[end,:],grid=false,xticks = ([0, 2.5, 5.0, 7.5, 10.0,12.5], [L"0", L"2.5", L"5.0", L"7.5", L"10.0",L"12.5"]),yticks = ([0, 50, 100, 150, 200], [L"0", L"50", L"100", L"150", L"200"]),color=:black,lw=1.5,legend=false,xlabel=L"R",ylabel=L"\mathrm{Average\,\,  degree}", dpi=1200)
